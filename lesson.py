...
# Горы 1(верхние)
center_1 = (mountain_1_size[0] // 50, mountain_1_size[1] * 4//5)
radius_1 = mountain_1_size[0] // 30
x1_2, y1_2 = mountain_1_size[0] // mountain_1_size[0], 1size[1] // 2   = mountain_1_size[1]
x2_2, y2_2 = mountain_1_size[0] // 40, mountain_1_size[1] * 17//20
x3_2, y3_2 = mountain_1_size[0] // 5, mountain_1_size[1] * 3//5
x4_2, y4_2 = mountain_1_size[0] // 4, mountain_1_size[1] * 19//30
x5_2, y5_2 = mountain_1_size[0] * 11//40, mountain_1_size * 7//10
x6_2, y6_2 = mountain_1_size[0] * 9//20, mountain_1_size * 22//25
x7_2, y7_2 = mountain_1_size[0] // 2, mountain_1_size * 67//80
x8_2, y8_2 = mountain_1_size[0] * 11//20, mountain_1_size * 367//400
x9_2, y9_2 = mountain_1_size[0] * 7//10, mountain_1_size * 11//20
x10_2, y10_2 = mountain_1_size[0] * 4//5,mountain_1_size 1size[1] * 14//20
x11_2, y11_2 = mountain_1_size[0] * 17//20, mountain_1_size * 13//20
x12_2, y12_2 = mountain_1_size[0] * 18//20, mountain_1_size * 15//20
x13_2, y13_2 = mountain_1_size[0] * 37//40, mountain_1_size * 14//20
x14_2, y14_2 = mountain_1_size[0], mountain_1_size *18//20
height_ellipse1 = mountain_1_size] // 5
width_ellipse1 = mountain_1_size[0] // 20
left_ellipse1 = mountain_1_size[0] * 27//40
top_ellipse1 = mountain_1_size * 11//20
...
mountain_1(mountain_1_surface, mountain_1_coordinates)
...
sun_surface = pygame.Surface((radius_sun * 2, radius_sun * 2), pygame.SRCALPHA, 32)
